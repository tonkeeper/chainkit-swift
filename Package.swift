...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "ChainKit",
            url: "https://github.com/tonkeeper/chainkit-swift/releases/download/0.0.1/ChainKit.xcframework.zip",
            checksum: "6babcb2dcdcdff762892c3cbecf02b1e1ced05721a639822622e327d79e01a5b"
        ),
        .binaryTarget(
            name: "WalletCore",
