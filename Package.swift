...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "ChainKit",
            url: "https://github.com/tonkeeper/chainkit-swift/releases/download/0.1.20/ChainKit.xcframework.zip",
            checksum: "8694d00b76d3a39f6bc866ab3b6835e7bea8e28e23ef814dbb4716384a64d73d"
        ),
        .binaryTarget(
            name: "WalletCore",
