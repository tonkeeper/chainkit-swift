...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "ChainKit",
            url: "https://github.com/tonkeeper/chainkit-swift/releases/download/0.1.15/ChainKit.xcframework.zip",
            checksum: "d7e2a97bd0f706d1a58474967ba6d5513a6c58d333b9a847128e1fce514bdae1"
        ),
        .binaryTarget(
            name: "WalletCore",
