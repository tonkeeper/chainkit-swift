...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "ChainKit",
            url: "https://github.com/tonkeeper/chainkit-swift/releases/download/0.1.22/ChainKit.xcframework.zip",
            checksum: "84a87697bb1747beaa1d2ab095e31a3ddf4950bbcf5d869dd69c15416cfa8cfe"
        ),
        .binaryTarget(
            name: "WalletCore",
