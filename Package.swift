...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "ChainKit",
            url: "https://github.com/tonkeeper/chainkit-swift/releases/download/0.1.21/ChainKit.xcframework.zip",
            checksum: "facd83335f64c0e7952621d81278a79a53f536cfdea09f8fe23919bb34e04b0a"
        ),
        .binaryTarget(
            name: "WalletCore",
