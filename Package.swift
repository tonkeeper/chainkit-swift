...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "ChainKit",
            url: "https://github.com/tonkeeper/chainkit-swift/releases/download/0.1.13/ChainKit.xcframework.zip",
            checksum: "458459cf2a2222baccce7eaaae35df4b3ceeba04b75cb9ac76564049c983503d"
        ),
        .binaryTarget(
            name: "WalletCore",
